...
/* [AM / DC] neutrino TCA approximation flags */
...
struct perturbations
{
  ...
  /* [AM / DC] --start-- flags to include collision correction terms in fluid approximations */
  short ufa_corrections;    /**< include collision term in ur fluid approximation shear */
  short ncdmfa_corrections; /**< include collision term in ncdm fluid approximation shear */
  /* [AM / DC] --end-- */
  ...
  /* [AM / DC] --start-- neutrino self-interaction collision integral tables */
  int num_q_collision;   /**< number of momentum bins in collision table */
  int num_ell_collision; /**< number of multipoles in C_ell table */
  int num_ell_alpha;     /**< number of multipoles in alpha_ell table */
  int    * ell;          /**< multipole values in C_ell table */
  double * q_collision;  /**< momentum bin values */
  double * C_ell;        /**< collision integrals C_ell(q), indexed [num_q*l + index_q] */
  double * ddC_ell;      /**< second derivatives for spline interpolation of C_ell */
  int C_ell_ncdm_size;   /**< number of species allocated in C_ell_ncdm */
  double ** C_ell_ncdm;  /**< C_ell interpolated on CLASS q-grid for each ncdm species */
  int    * ell_2;        /**< multipole values for alpha_ell table */
  double * alpha_ell;    /**< alpha_ell coefficients for massless neutrino collision term */
  /* [AM / DC] --end-- neutrino self-interaction collision integral tables */
...
struct perturbations_workspace
{
  ...
  */
  ...
  /* [AM / DC] neutrino TCA workspace quantities */
  double tca_shear_ur;      /**< ur neutrino shear in neutrino tight-coupling approximation */
  ...
  /* [AM / DC] --start-- neutrino TCA approximation index */
  int index_ap_nu_tca; /**< index for neutrino self-interaction tight-coupling approximation */
...
extern "C" {
  ...
  /* [AM / DC] --start-- neutrino self-interaction collision table I/O */
