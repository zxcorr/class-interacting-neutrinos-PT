...
struct background
{
  ...
  /* [AM / DC] --start-- neutrino self-interaction parameters */
  double log10_G_eff_nu; /**< Log10 of the effective neutrino coupling constant [MeV^-2] */
  double G_eff_nu;       /**< Effective neutrino coupling constant [MeV^-2] */
  double interacting_nu; /**< Flag: 0 = non-interacting, nonzero = interacting */
  /* [AM / DC] --end-- */
  ...
  /* [AM / DC] */
  int index_bg_Gamma_ur;      /**< interaction rate of massless neutrinos/relics [Mpc^-1] */
  ...
  /* [AM / DC] */
  int index_bg_Gamma_ncdm1;    /**< interaction rate of first ncdm species [Mpc^-1] */
