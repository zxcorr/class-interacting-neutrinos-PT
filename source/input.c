...
#undef __ASSIGN_DEFAULT_PRECISION__
  ...
  /* [AM /DC] set collision data file paths using compile-time CLASSDIR */
  sprintf(ppr->interacting_C_ell_file_syn, "%s%s", __CLASSDIR__, "/neutrinos_collision_terms/Coll_integrals_5_qbins.dat");
  sprintf(ppr->interacting_C_ell_file_new, "%s%s", __CLASSDIR__, "/neutrinos_collision_terms/Coll_integrals_11_qbins.dat");
  sprintf(ppr->interacting_alpha_ell_file, "%s%s", __CLASSDIR__, "/neutrinos_collision_terms/Massless_alpha_l.dat");    
  /* [AM / DC] --end-- */        
...
int input_read_parameters_spectra(struct file_content * pfc,
  ...
  /* [AM / DC]  --start-- */
  /* neutrino self-interaction coupling */
  ...
  /* values below -6 treated as zero (ΛCDM limit) */
...
int input_default_params(struct background *pba,
  ...
  /* [AM / DC] --start-- neutrino self-interaction defaults */
